<x-app-layout>
    ...
    <x-modal name="keywords-modal" :show="false" focusable>
        <div class="p-6 light-modal-content" x-data="{ selectedKeywords: [] }">
            <h2 class="text-lg font-medium text-gray-900">{{ __('Select Keywords') }}</h2>
            <div class="mt-4 space-y-2">
                 <label class="flex items-center p-2 rounded-md hover:bg-gray-100"><input class="keyword-checkbox rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" type="checkbox" value="00 Policy & Principle: PP" x-model="selectedKeywords"><span class="ms-2 text-sm text-gray-600">00 Policy & Principle: PP</span></label>
                 <label class="flex items-center p-2 rounded-md hover:bg-gray-100"><input class="keyword-checkbox rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" type="checkbox" value="10 Management System: MS" x-model="selectedKeywords"><span class="ms-2 text-sm text-gray-600">10 Management System: MS</span></label>
                 <label class="flex items-center p-2 rounded-md hover:bg-gray-100"><input class="keyword-checkbox rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" type="checkbox" value="20 Business & Operation: BO" x-model="selectedKeywords"><span class="ms-2 text-sm text-gray-600">20 Business & Operation: BO</span></label>
                 <label class="flex items-center p-2 rounded-md hover:bg-gray-100"><input class="keyword-checkbox rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" type="checkbox" value="90 Others: OT" x-model="selectedKeywords"><span class="ms-2 text-sm text-gray-600">90 Others: OT</span></label>
            </div>
